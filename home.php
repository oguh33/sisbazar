...
<div class="container-fluid">
    ...
    <!-- DataTables Example -->
    <div class="card-body ocultar" id="vendas" style="display: none">
        <div class="table-responsive">
            <table class="table table-bordered display" id="" width="100%" cellspacing="0">
                ...
                <tbody>
                <?php foreach ($vendasPorItem as $vendas): //echo '<pre>'; var_dump($rs); die;?>
                    <tr>
                        <td><?php echo $objInicial->inverteData($vendas[0]->data, '-', '/'); ?></td>
                        <td><?php echo str_pad($vendas[0]->ven_id, 6, "0", STR_PAD_LEFT); ?></td>
                        <td><?php echo mb_strtoupper($vendas[0]->nome, 'UTF-8'); ?></td>
                        <td>
                        ...
                        <td><?php echo 'R$ ' . number_format($vendas[0]->valor_total, 2, ',', '.'); ?></td>
                        <td><?php echo $vendas[0]->pg_descricao; ?></td>
                        <td><?php echo $vendas[0]->descricao; ?></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
